...
def run_small_example():
    ...
    try:
        ...
        wtk_ws_data_filepath = Path(data_dir) / "wtk_small_example_windspeed_100m_2020.feather"
        wtk_wd_data_filepath = Path(data_dir) / "wtk_small_example_winddirection_100m_2020.feather"
        wtk_coords_filepath = Path(data_dir) / "wtk_small_example_coords_2020.feather"

        # Using downloaded WTK files, spatially interpolate wind speeds and directions and at 6
