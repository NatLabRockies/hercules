"""NSRDB solar irradiance data downloader.

This module provides the `download_nsrdb_data` function, which was
previously defined in `wind_solar_resource_downloader`. The implementation
is moved here without functional changes to support a more modular
