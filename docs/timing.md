...
**outputs** of the PySAM solar model when `use_native_solar_dt` is active
...
[Native-resolution PySAM execution](solar_pv.md#native-resolution-pysam-execution-use_native_solar_dt).
