...
def test_log_h_dict_refactored():
    ...
    assert expected_keys.issubset(actual_keys), f"Missing expected keys: {expected_keys - actual_keys}"
    ...
    unexpected_keys = [k for k in actual_keys if k.startswith("solar_farm.dni") or k.startswith("solar_farm.ghi")]
